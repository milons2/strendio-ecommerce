...
// Fetch kids products using slug for reliability
$query = "
    SELECT p.*, c.slug 
    FROM products p 
...
$defaultImage = "uploads/kids/default.png";
?>
...
.promo-badge {
    background: #ffc107; /* Brighter color for kids */
    color: #000;
    padding: 4px 12px;
    border-radius: 50px;
    font-size: 11px;
...
<div class="container py-5">
    ...
    <div class="shop-header d-flex justify-content-between align-items-center">
        <div>
            ...
            <h2>Little Strendio Stars</h2>
            <p class="text-muted mb-0">Adorable, comfy, and festive styles for your little ones.</p>
        </div>
        <div class="text-end d-none d-md-block">
            <h5 class="mb-1 text-danger">Flat 25% OFF</h5>
            <p class="small text-muted mb-0">Festive joy applied at checkout</p>
        </div>
    </div>
    ...
    <div class="row g-4">
        ...
        <?php else: ?>
            <div class="col-12 text-center py-5">
                ...
                <h4 class="text-muted mt-3">New kids styles arriving soon!</h4>
            </div>
        <?php endif; ?>
    </div>
</div>
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-md-3 info-item">
                ...
                <h6>Soft & Safe</h6>
                <p>100% kid-friendly breathable fabrics</p>
            </div>
            <div class="col-md-3 info-item">
                <i class="bi bi-truck"></i>
                <h6>Fast Delivery</h6>
                <p>Dhaka 24h | Nationwide 72h</p>
            </div>
            <div class="col-md-3 info-item">
                <i class="bi bi-shield-check"></i>
                <h6>Secure Pay</h6>
                <p>Safe bKash & Card payments</p>
            </div>
            <div class="col-md-3 info-item">
                <i class="bi bi-arrow-repeat"></i>
                <h6>Easy Size Swap</h6>
